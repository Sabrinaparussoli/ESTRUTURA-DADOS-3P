...
/* InicializaÃ§Ã£o da lista sequencial (a lista jÃ¡ estÃ¡ criada e Ã© apontada 
pelo endereÃ§o em l) */
...
/* ExibiÃ§Ã£o da lista sequencial */
...
/*InserÃ§Ã£o dos elementos na lista */
...
/* ExclusÃ£o do elemento cuja chave seja igual a ch */
int excluirElemLista(LISTA* l, int ch) { 
  int chave, j;
  chave = buscaSequencial(l,ch);
  if(chave == -1) return 0; // nÃ£o existe
...
int main(){
// Blocos de testes das funÃ§Ãµes desenvolvidas
